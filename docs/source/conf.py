...
myst_html_meta = {
    "description": "IP2Location Kafka Transform provides a fast lookup of geolocation information from IP address by using IP2Location database.",
    "keywords": "IP2Location, Geolocation, IP location, Kafka",
